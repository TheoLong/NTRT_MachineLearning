...
private:
  ...
  void setMuscleTargetLength(TandemModel6& subject, double dt, std::string tag, double originalLength, double endLength, int startTime, int rampTime, int holdTime);

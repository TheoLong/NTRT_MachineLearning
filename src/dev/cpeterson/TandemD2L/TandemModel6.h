...
#ifndef Tandem_MODEL6_H
#define Tandem_MODEL6_H

/**
 * @file TandemModel6.h
 * @brief Contains the definition of class TandemModel6.
 * $Id$
 */
 ...
 */
class TandemModel6 : public tgSubject<TandemModel6>, public tgModel
{
public: 

...
void AppTerrainJSON::handleOptions(int argc, char **argv)
{
...
const tgHillyGround::Config AppTerrainJSON::getHillyConfig()
{
...
const tgBoxGround::Config AppTerrainJSON::getBoxConfig()
{
...
tgModel* AppTerrainJSON::getBlocks()
{
...
tgWorld* AppTerrainJSON::createWorld()
{
...
tgSimViewGraphics *AppTerrainJSON::createGraphicsView(tgWorld *world)
{
    return new tgSimViewGraphics(*world, timestep_physics, timestep_graphics);
}

tgSimView *AppTerrainJSON::createView(tgWorld *world)
{
    return new tgSimView(*world, timestep_physics, timestep_graphics);
}

bool AppTerrainJSON::run()
{
    if (!bSetup)
    {
        setup();
...
void AppTerrainJSON::simulate(tgSimulation *simulation)
{
...
{
    std::cout << "AppTerrainJSON" << std::endl;
    AppTerrainJSON app (argc, argv);

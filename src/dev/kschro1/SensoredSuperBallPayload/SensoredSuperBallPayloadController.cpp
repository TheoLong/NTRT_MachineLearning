...
void SuperBallPrefLengthController::onSetup(SensoredSuperBallPayload& subject)
{
...
void SuperBallPrefLengthController::onStep(SensoredSuperBallPayload& subject, double dt)
{
    if (dt <= 0.0)
    {
...
void SuperBallPrefLengthController::applyActions(SensoredSuperBallPayload& subject, vector< vector <double> > act)
{

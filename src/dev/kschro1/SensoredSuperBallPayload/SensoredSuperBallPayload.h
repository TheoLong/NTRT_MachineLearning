...
/**
 * @file SensoredSuperBallPayload.h
 * @brief Contains the definition of class SensoredSuperBallPayload.
 * $Id$
 */
 ...
 */
class SensoredSuperBallPayload : public tgSubject<SensoredSuperBallPayload>, public tgModel
{
public: 
     ...
     * not passed in. 
     */
    SensoredSuperBallPayload();
	
    /**
     * Destructor. Deletes controllers, if any were added during setup.
     * Teardown handles everything else.
     */
    virtual ~SensoredSuperBallPayload();
...
private:
	...
	/**
     * A function called during setup that creates a sphere from the
     * relevant node. Rewrite this function for your own models.
     * @param[in] s A tgStructure that we're building into
     */

     void addSphere(tgStructure& s);

...
/**
 * @file SensoredSuperBallPayloadController.h.h
 * @brief Contains the definition of class SensoredSuperBallPayloadController.
 * @author Atil Iscen
 * @version 1.0.0
 * $Id$
 */
...
class SensoredSuperBallPayload;
 ...
 */
class SuperBallPrefLengthController : public tgObserver<SensoredSuperBallPayload>
{
public:
  ...
  virtual void onSetup(SensoredSuperBallPayload& subject);
    
  virtual void onStep(SensoredSuperBallPayload& subject, double dt);

protected:

  virtual vector< vector <double> > transformActions(vector< vector <double> > act);

  virtual void applyActions (SensoredSuperBallPayload& subject, vector< vector <double> > act);

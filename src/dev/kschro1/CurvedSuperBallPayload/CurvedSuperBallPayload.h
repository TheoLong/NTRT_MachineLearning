...
/**
 * @file CurvedSuperBallPayload.h
 * @brief Contains the definition of class CurvedSuperBallPayload.
 * $Id$
 */
 ...
 */
class CurvedSuperBallPayload : public tgSubject<CurvedSuperBallPayload>, public tgModel
{
public: 
     ...
     * not passed in. 
     */
    CurvedSuperBallPayload();
	
    /**
     * Destructor. Deletes controllers, if any were added during setup.
     * Teardown handles everything else.
     */
    virtual ~CurvedSuperBallPayload();

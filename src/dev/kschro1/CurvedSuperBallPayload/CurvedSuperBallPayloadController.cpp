...
// This module
#include "CurvedSuperBallPayloadController.h"
// This application
...
void SuperBallPrefLengthController::onSetup(CurvedSuperBallPayload& subject)
{
...
void SuperBallPrefLengthController::onStep(CurvedSuperBallPayload& subject, double dt)
{
    if (dt <= 0.0)
    {
...
void SuperBallPrefLengthController::applyActions(CurvedSuperBallPayload& subject, vector< vector <double> > act)
{

...
/**
 * @file CurvedSuperBallPayloadController.h.h
 * @brief Contains the definition of class CurvedSuperBallPayloadController.
 * @author Atil Iscen
 * @version 1.0.0
 * $Id$
 */
 ...
 */
class SuperBallPrefLengthController : public tgObserver<CurvedSuperBallPayload>
{
public:
  ...
  virtual void onSetup(CurvedSuperBallPayload& subject);
    
  virtual void onStep(CurvedSuperBallPayload& subject, double dt);

protected:

  virtual vector< vector <double> > transformActions(vector< vector <double> > act);

  virtual void applyActions (CurvedSuperBallPayload& subject, vector< vector <double> > act);
